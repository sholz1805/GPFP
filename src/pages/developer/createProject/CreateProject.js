...
const CreateProject = () => {
  ...
  const selectedStateData = formData.projectLocation?.state
    ? NaijaStates.lgas(formData.projectLocation.state)
    : null;
      ...
      <div className="max-w-2xl px-10 sm:mx-4 sm:pt-6">
        ...
        <div className="mb-4 relative">
          ...
          >
            ...
            <option value="C&I and Productive use">
              C&I and Productive use
            </option>
